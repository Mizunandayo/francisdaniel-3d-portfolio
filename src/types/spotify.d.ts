 ...
 *
 * Everything inside declare global makes both Window and the Spotify
 * namespace available across all files without any import needed.
 * The export {} at the bottom makes this a module — required for
...
declare global {
  interface Window {
    /**
     * Called by the SDK script once it has fully loaded.
     * Must be set BEFORE the script tag is injected.
     */
